...
dev-worker:
	uv run --package backend taskiq worker apps.backend.app.core.broker:broker apps.backend.app.features.parse_document.tasks apps.backend.app.features.chunk_document.tasks apps.backend.app.features.embed_document.tasks --workers 1 --reload --reload-dir apps/backend
